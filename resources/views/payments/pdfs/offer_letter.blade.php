...
<body>
    ...
    <div class="page">
        ...
        <p class="content-text"> The Focuz Academy is one of the pioneers in distance education and super child of a giant education 
...
the art learning infrastructure and outstanding services at your convenience. We do facilitate a wide
 ...
 details will be as follows:</p>
    ...
    <div class="page">
        ...
        <p class="content-text">Your course has different phases that make it easier to complete a degree certificate. All of these phases are illustrated as follow.</p>
        ...
        <div class="phase-section">
            ...
            <p class="content-text">Once the center registration has been completed, you will be provided with a track ID, through which we can track your application in the center. For the purpose of university registration, we ask all our student to send a clear copy of the documents listed below to the email ID, Indicating the name and track ID as subject to:<br>
          <a href="mailto:focuz.admissiondocs@gmail.com" class="email-link">focuz.admissiondocs@gmail.com</a></p>
            <ul>
            ...
            <div class="highlight-box">
                ...
                <p style="margin-top: 10px;"><strong>If any service not received on next day of admission, students can mail to:</strong><br>
                <a href="mailto:focuz.solutions@gmail.com" class="email-link">focuz.solutions@gmail.com</a></p>
            </div>
        </div>
        ...
        <div class="phase-section">
            ...
            <p class="content-text">Students can check their University registration, Photo verification, Course & Specialization verification, Study material access, Pre-recorded classes, Exam notification, Exam result, etc...</p>
            ...
            <p class="content-text">Once completing LMS, student can access text book soft copy in their university portal.</p>
            <p class="content-text">University text books will only issued to the students after the center registration. There will be an extra charge for text book (Hard copy). Once you get the text books student should give the students affairs executive the acknowledgement.</p>
        </div>
    ...
    <div class="page">
        <div class="header">
            <svg class="logo" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M30 45 L50 25 L70 45 L65 45 L65 65 L55 65 L55 50 L45 50 L45 65 L35 65 L35 45 Z" fill="white"/>
        ...
        <div class="phase-section">
            ...
            <p class="content-text">University Registration begins as per the notification from the university and end on or before a specified date, which will be updated by your student's affairs executive.</p>
            <p class="content-text">First semester fee has to be paid one month prior to university registration. If you do not meet the criteria, your application will not be registered and proceed to the next batch.</p>
            <p class="content-text">Student has to make sure we received all your educational documents via email, as mentioned in the initial admission stage.</p>
        </div>
        
        <div class="phase-section">
            <div class="phase-title">4. University Registration Phase</div>
            <p class="content-text">University registration process will commence after receiving all necessary documents and fees.</p>
        </div>
        
        <div class="phase-section">
            <div class="phase-title">5. Assignment</div>
            <p class="content-text">Students must receive an acknowledgement from executives that their assignment or projects have been collected and accepted in accordance with the guidelines.</p>
            <p class="content-text">The Assignment should be hand written, and all subject of the semester should be bound together and not separate.</p>
            <p class="content-text"><strong>The submission of assignment is mandatory one month prior to examination date. If not, there will be semester back paper fee.</strong></p>
        ...
        <div class="phase-section">
            ...
            <p class="content-text"><strong>The project submission is mandatory one month prior to examination date. If not, there will be a chance of failure.</strong></p>
        </div>
        
        <div class="phase-section">
            <div class="phase-title">7. Examination Phase</div>
            <p class="content-text">A qualifying fee have to be paid one month prior to the registration date of the examination at the university.</p>
            <p class="content-text">Academy will be registering student after checking their fee eligibility and assignment status.</p>
            <p class="content-text">Students will receive examination time table, Examination writing guidelines, and hall tickets before the examination itself.</p>
            <p class="content-text"><strong>All students should strictly adhere to exam rules and regulations.</strong></p>
        </div>
        
        <div class="phase-section">
            <div class="phase-title">8. Result & Mark List Phase</div>
            <p class="content-text">After the examination, the university will publish the result within three months, our center will not be responsible for any delay on the part of the university.</p>
            <p class="content-text">If you do not attend a minimum of 3 subject per semester, your academic year will be extended to the following year and you will have to pay the back-paper registration fee to reappear the examination.</p>
            <p class="content-text">The date and venue of the convocation ceremony shall be fixed by the university. There would be a fee for convocation and final certificate.</p>
        </div>
    ...
    <div class="page">
        ...
        <div class="phase-section">
            ...
            <p class="content-text">If, for any reason the student does not attend the convocation ceremony, they shall be asked to pay the Provisional certificate fee and to collect the certificate directly from the academy.</p>
            <p class="content-text">Our service extends until the end of the semester. Students have the option to apply for the main degree certificate directly at the university, or we can apply on their behalf, with charges applicable for the service.</p>
        </div>
        ...
        <div class="note-box">
            <p>If you feel free to convey your suggestions or complaints, Don't hesitate to contact us. For any further queries regarding details of the course, suggestion and complaints, feel free to contact our whats app assistance number @</p>
            <p style="margin-top: 8px;"><strong>(Note: Dear Students,</strong> kindly make sure to either acknowledge the mail or signing and send back the signed softcopy to the same mail. If we are unable to receive it will consider as verified and acknowledge it from your end.</p>
            <p style="margin-top: 8px;">Until and unless there is rejection from the university side, there won't be no refund approved.)</p>
        </div>
        
        <div class="section-title">Declaration</div>
        <div class="declaration-box">
            <p>I hereby declare that, I accept and agree all the terms and conditions in the offer letter and will abide all the rules and regulations of the institute correctly. I understood that, if any kind of delay from any side which affect successful completion of my course the center would not be responsible.</p>
